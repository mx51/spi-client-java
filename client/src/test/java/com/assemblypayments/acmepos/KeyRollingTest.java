...
public class KeyRollingTest {
    ...
    @Test
    public void testKeyRolling() throws Exception {
        Message krRequest = new Message("x", Events.KEY_ROLL_REQUEST, null, false);

        Secrets oldSecerts = new Secrets("11A1162B984FEF626ECC27C659A8B0EEAD5248CA867A6A87BEA72F8A8706109D", "40510175845988F13F6162ED8526F0B09F73384467FA855E1E79B44A56562A58");

        KeyRollingResult krResult = KeyRollingHelper.performKeyRolling(krRequest, oldSecerts);
